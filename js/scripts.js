...
if (loginForm) {
  loginForm.addEventListener("submit", function (event) {
    ...
    if (username === "" || password === "") {
      document.getElementById("error-message").innerText = "Por favor, rellena todos los campos";
      ...
      if (!usuarioValido) {
        ...
        alert("Acceso concedido para el usuario: " + username);
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  salirBtn.addEventListener("click", function (e) {
    e.preventDefault();
    const confirmar = confirm("¿Estás seguro que deseas salir del Menu?");
    if (confirmar) {
      window.location.href = "index.html"; 
    }
  });
